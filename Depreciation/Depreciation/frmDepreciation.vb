...
'               the depreciation based on a 5 year life of the items in inventory
...
Public Class frmDepreciation
    ...
    Private Sub frmDepreciation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim strLocationAndNameOfFile As String = "H:\Visual Basic 2017\VB17-Chapter.08\inventory.txt"
    ...
    Private Sub StraightLineDepreciation(ByVal intItemId As Integer)
        ...
        ' Loop repeats for the life of the items
    ...
    Private Sub DoubleDecliningDepreciation(ByVal intItemId As Integer)
        ' This Sub procedure compute and displays the double declining
    ...
    Private Sub MakeObjectsVisible()
        ' This procedure display the objects showing the results
    ...
    Private Sub mnuDisplay_Click(sender As Object, e As EventArgs) Handles mnuDisplay.Click
        ' The mnuDisplay click event creates an instance of thr frmDisplayInventory
