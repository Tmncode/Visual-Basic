'Program Name:  Scuba Exepitions Application
'Author:        Tam M. Nguyen
'Date:          August 19, 2020
'Purpose:       The Scuba Expeditions app determines the location and scuba dive available and calculates the total dive team cost.
...
Public Class frmScuba
    ...
    Private Sub cboLocation_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboLocation.SelectedIndexChanged
        ' This event handler allows the user to enter the location choice and then calls subprocedures to place thr=e dive types in the list.
    ...
    Private Sub btnDiveCost_Click(sender As Object, e As EventArgs) Handles btnDiveCost.Click
        ' This button event handler determines the cost of scuba expeditiions and
        ...
        ' If number of people and the dive trip are valid, calulate the cost
        If (blnNumberInTeamIsValid And blnDiveIsSelected) Then
            ...
            lblCost.Text = "Cost: " & decTotalCost.ToString()
